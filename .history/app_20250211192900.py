...
from pinecone import Pinecone  # Not PineconeClient
  # Instead of 'Pinecone'
...
# Pinecone setup
pinecone.init(api_key="pcsk_6hfbZM_PyDhaPVXZs1H5ddoLnsEWx7iNai3SZR8Mfbgsf59yEKteEmXsiatUEu5q2RPML2", environment="us-east-1")  
index_name = "medbot"
